...
/* updateSysMenu49*/
INSERT INTO `losys`.`lo_logistics` (`id`, `name`, `size`, `compare`, `formula`, `value`, `quantity`, `calType`, `opBy`, `opAt`, `delFlag`) VALUES ('d8af6c76f11147cd9cde0f23de28d3db', '跨越', '10000', '+25', 'last*width*height/size*pricecompare', '150', '2', '2', 'ccb77b82f75b44a9847aeff7ac38a0b5', '1522401420', '0');
/* updateSysMenu50*/
